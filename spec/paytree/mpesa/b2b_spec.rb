RSpec.describe Paytree::Mpesa::B2B do
  ...
  describe "parameter validation" do
    ...
    context "receiver_shortcode validation" do
      it "raises ValidationError when blank" do
        expect {
          described_class.call(short_code:, receiver_shortcode: "", amount: 100, account_reference: "REF-123")
        }.to raise_error(Paytree::Errors::ValidationError, /receiver_shortcode cannot be blank/)
      end
    end
    ...
    context "account_reference validation" do
      it "raises ValidationError when blank" do
        ...
        }.to raise_error(Paytree::Errors::ValidationError, /account_reference cannot be blank/)
      end
    end
    ...
    context "command_id validation" do
      it "raises ValidationError when invalid" do
        ...
        }.to raise_error(Paytree::Errors::ValidationError, /command_id must be one of: BusinessPayBill, BusinessBuyGoods/)
      end
    ...
    context "config validation" do
      it "raises ConfigurationError when result_url is missing" do
        ...
        }.to raise_error(Paytree::Errors::ConfigurationError, /Missing `result_url` in Mpesa extras config/)
      end
      ...
      it "raises ConfigurationError when timeout_url is missing" do
        ...
        }.to raise_error(Paytree::Errors::ConfigurationError, /Missing `timeout_url` in Mpesa extras config/)
      end
    end
  end
end
